function [img,nd_image] = Abs_Analysis_FB(varargin)
...
% roiRow = 1600 + 200*[-1,1]; %580,800
% roiRow = [1200 + 150*[-1,1];1600 + 150*[-1,1]]; %580,800
% roiCol = 1050 + 200*[-1,1]; %850,1400
roiRow = [1,128];
roiCol = [1,128];
% roiRow = [500 + 150*[-1,1];
%           815 + 150*[-1,1];
...
imgconsts = AtomImageConstants(atomType,'tof',tof,'detuning',detuning,...
    'pixelsize',5.5e-6,'exposureTime',30e-6,'polarizationcorrection',1,'satOD',11);
...
if numImages == 1 && size(raw.images,3) >= 5
%     sum_idx_y = 500:580;
%     sum_idx_x = 925:1025;
%     row = 510:570;
%     col = 1040:1120;
